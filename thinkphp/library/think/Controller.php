...
class Controller
{
    ...
    const NEED_LOGIN        = false;        // $this->checkRole() flag
    const NEED_PRIVILEGE    = null;
    ...
    protected function success($msg = '', array $data = []){
        return json([
            'success' => true,
            'msg' => $msg ?: Status::MESSAGE[Status::SUCCESS],
            'data' => $data, 
            'code' => Status::SUCCESS
        ]);
    }
     ...
     * 返回错误状态
     *
     * @param array $status      状态 app\common\Status
     * @param string $msg
     * @param array $data
     * @return json
     */
    protected function error($status, $msg = '', array $data = []){
        return json([
            'success' => false,
            'msg' => $msg ?: Status::MESSAGE[$status],
            'data' => $data, 
            'code' => $status
        ]);
    }
